...
import com.afilimonov.gitbrowser.model.User;
...
public class SetUserNameFragment extends BaseFragment {
	...
	private void initUser() {
		User user = new User();
		user.setName(Preferences.getString(Constants.USER_NAME_KEY, getContext().getString(R.string.userNameDefault), getContext()));
	}
