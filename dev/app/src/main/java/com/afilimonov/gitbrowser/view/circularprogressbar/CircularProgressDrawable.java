package com.afilimonov.gitbrowser.view.circularprogressbar;
...
import static com.afilimonov.gitbrowser.view.circularprogressbar.CircularProgressBarUtils.*;
...
public class CircularProgressDrawable extends Drawable
    ...
    public CircularProgressDrawable(int[] colors,
                                    float borderWidth,
                                    float sweepSpeed,
                                    float rotationSpeed,
                                    int minSweepAngle,
